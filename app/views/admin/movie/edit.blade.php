        ...
        <div class="col-md-12">
            ...
            <div class="portlet light">
                ...
                <div class="portlet-body form">
                    ...
                    {{ Form::model($movie, ['route' => ['admin.movie.update', $movie->id], 'method' => 'put', 'files' => true]) }}
                            ...
                            <div class="col-md-6">
                                <div class="form-body">
                                    <div class="form-group">
                                        ...
                                        {{ Form::select('category_ids[]', $categories, $selectedCategories, ['class' => 'form-control select2', 'multiple']) }}
                                        {{-- <select name="category_ids" id="category_ids" class="form-control select2" multiple="multiple">
                                            @foreach($categories as $id => $value)
                                                <option value="{{ $id }}" {{ (in_array($id, $selectedCategories)) ? "selected='selected'" : null }}>{{ $value }}</option>
                                            @endforeach
                                        </select> --}}
                                    </div>
